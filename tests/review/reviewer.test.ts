...
describe('reviewPullRequest', () => {
  ...
  it('fails oversized Qwen reviews before inference without posting or caching a clean review', async () => {
    ...
    await expect(reviewPullRequest({ db, llm, retrieve: retrieveOne, github: gh.github, statusContext: 'repolens/review' }, { repoId: REPO_ID, prNumber: 42 })).rejects.toThrow('$0.05');
